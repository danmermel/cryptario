...
aws dynamodb create-table --table-name "cryptarioDictionary-${SUFFIX}" \
  --billing-mode PAY_PER_REQUEST \
  --attribute-definitions AttributeName=id,AttributeType=S AttributeName=problem,AttributeType=S \
