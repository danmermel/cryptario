...
# copy the charades/utilities libraries here for deployment
cp ../../*.js ../../config.json ../../dictionary*.json .
...
# build the zip
zip -r lambda.zip package.json *.js config.json node_modules/ dictionary.json
